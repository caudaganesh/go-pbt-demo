...
func (m *mysqlArticleRepository) fetch(ctx context.Context, query string, args ...interface{}) ([]*entity.Article, error) {
...
func (m *mysqlArticleRepository) Fetch(ctx context.Context, cursor string, num int64) ([]*entity.Article, string, error) {
...
func (m *mysqlArticleRepository) GetByID(ctx context.Context, id int64) (res *entity.Article, err error) {
	query := `SELECT id,title,content, author_id, updated_at, created_at
...
func (m *mysqlArticleRepository) GetByTitle(ctx context.Context, title string) (res *entity.Article, err error) {
	query := `SELECT id,title,content, author_id, updated_at, created_at
...
func (m *mysqlArticleRepository) Store(ctx context.Context, a *entity.Article) error {
...
func (m *mysqlArticleRepository) Update(ctx context.Context, ar *entity.Article) error {
